...
Source Database       : saintic_dev_new

Target Server Type    : MYSQL
Target Server Version : 50717
File Encoding         : 65001

Date: 2017-04-05 23:25:00
*/
...
-- ----------------------------
INSERT INTO `sys_notice` VALUES ('1', '各位用户好，本站博客由原本Interest.blog全站更新设计为EauDouce，请关关注。');
INSERT INTO `sys_notice` VALUES ('2', '第二个消息，关于其他数据的');
...
-- ----------------------------
INSERT INTO `user_profile` VALUES ('1', 'admin', 'staugur@saintic.com', '管理员', '/static/img/avatar/default.jpg', 'Men always fight alone, always in the challenge of their own.', 'http://www.saintic.com', '2016-10-14', 'http://weibo.com/staugur', 'github.com/staugur', '男', 'Administrator', 'true');
